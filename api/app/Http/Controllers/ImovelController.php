...
class ImovelController extends Controller
{
    ...
    public function pesquisarMoradorPorImovel($quadra, $lote)
    {
        $result = Imovel::join('imovel_permanente', 'imovel.id','=','imovel_permanente.id_imovel')
            ...
            ->select('imovel.quadra','imovel.lote','pessoa.nome',\DB::raw('pessoa.id as pessoa_id'),'imovel.id')
            ->where(\DB::raw('imovel.quadra'), 'like','%'. $quadra . '%')
            ->where(\DB::raw('imovel.lote'),'like','%' . $lote . '%')
