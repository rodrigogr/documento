...
class TipoTelefoneController extends Controller
{
     ...
     *
     * @param  TipoTelefoneRequest $request
     * @return \Illuminate\Http\Response
     */
    public function store(TipoTelefoneRequest $request)
    {
        try {
            $data = $request->all();
            $Data = TipoTelefone::create($data);
        } catch (Exception $e) {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(TipoTelefoneRequest $request, $id)
    {
        $Data = TipoTelefone::find($id);
        if (count($Data)) {
            try {
