    ...
    <div ui-view>
        ...
        <div id="corpo">
            <div class="content">
                <h2>Olá {{ $associado }}!</h2>
                <br>
                <p>Seu boleto com vencimento dia {{ $vencimento }} foi gerado com sucesso e já está diponivel em anexo para pagamento.</p>
                <br>
                <h3>Este é o resumo dos lançamentos:</h3>
                ...
                <br>
                <p>Dúvidas?</p>
                <p>Caso tenha ficado alguma dúvida, procure a administração do condomínio.</p>
            </div>
        </div>
        <div id="footer">
            <row>
